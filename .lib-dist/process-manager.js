 ...
 class QueryProcessWrapper {
	...
	safeJSON(obj) {
		...
		try {
			...
			_optionalChain([global, 'access', _ => _.Monitor, 'optionalAccess', _2 => _2.crashlog, 'optionalCall', _3 => _3(e, `a ${path.basename(this.file)} process`, {result: obj})]);
			return undefined;
		}
	}
 ...
 */
 ...
 class RawProcessManager extends ProcessManager {
	...
	/** worker ID of cluster worker - cluster child process only (0 otherwise) */
	 __init22() {this.workerid = _optionalChain([cluster, 'access', _6 => _6.worker, 'optionalAccess', _7 => _7.id]) || 0}
	...
	spawn(count) {
		...
		if (!this.workers.length) {
			...
			_optionalChain([this, 'access', _8 => _8.spawnSubscription, 'optionalCall', _9 => _9(this.masterWorker)]);
		}
	}
	createProcess() {
		const process = new RawProcessWrapper(this.filename, this.isCluster, this.env);
		this.workers.push(process);
		_optionalChain([this, 'access', _10 => _10.spawnSubscription, 'optionalCall', _11 => _11(process)]);
		return process;
	}
	destroyProcess(process) {
		...
		_optionalChain([this, 'access', _12 => _12.unspawnSubscription, 'optionalCall', _13 => _13(process)]);
	}
