...
const afdSSBSets = {
 ...
 class RandomStaffBrosTeams extends _randomteams.default {
	randomStaffBrosTeam(options = {}) {
		...
		let pool = debug.length ? debug : wiiulegacy ? Object.keys(afdSSBSets) : Object.keys(exports.ssbSets);
		...
		while (pool.length && team.length < this.maxTeamSize) {
			...
			const ssbSet = wiiulegacy ? this.dex.deepClone(afdSSBSets[name]) : this.dex.deepClone(exports.ssbSets[name]);
