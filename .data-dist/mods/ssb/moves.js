"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }var _conditions = require('./conditions');
	...
	*/
	...
	reset: {
		...
		onHit(pokemon) {
			...
			if (pokemon.species.baseSpecies === 'Aegislash') {
				...
				_abilities.changeSet.call(void 0, this, pokemon, _randomteams.ssbSets[specialSet ? 'aegii' : 'aegii-Alt']);
	...
	lilypadoverflow: {
		...
		basePowerCallback(source, target, move) {
			if (!_optionalChain([source, 'access', _ => _.volatiles, 'access', _2 => _2['raindrop'], 'optionalAccess', _3 => _3.layers])) return move.basePower;
	...
	datacorruption: {
		...
		onHit(target, source) {
			...
			const newMoveSlots = _abilities.changeMoves.call(void 0, this, target, newMoves);
	...
	broadsidebarrage: {
		...
		onPrepareHit(target, source) {
			...
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Archas')}|Fire all guns! Fiiiiire!`);
		},
	...
	radiantburst: {
		...
		onHit(target, pokemon) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Arcticblast')}|YEET`);
	...
	baneterrain: {
		...
		condition: {
			duration: 5,
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _6 => _6.hasItem, 'call', _7 => _7('terrainextender')])) {
					return 8;
				}
				return 5;
			},
	...
	getoffmylawn: {
		...
		onHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'drampa\'s grandpa')}|GET OFF MY LAWN!!!`);
		},
		secondary: null,
		forceSwitch: true,
		target: "normal",
	...
	youhavenohope: {
		...
		onHit(target, source) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'explodingdaisies')}|You have no hope ${target.name}!`);
		},
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	soupstealing7starstrikeredux: {
		...
		onHit(target, source) {
			...
			if (this.randomChance(1, 2)) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'fart')}|I hl on soup`);
			} else {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'fart')}|I walk with purpose. bring me soup.`);
			}
		},
		condition: {
			duration: 2,
		...
		onHit(target, source, move) {
			...
			if (source.species.baseSpecies === 'Alcremie') {
				const formes = ['Finland', 'Finland-Tsikhe', 'Finland-Nezavisa', 'Finland-Järvilaulu']
					.filter(forme => _randomteams.ssbSets[forme].species !== source.species.name);
				const newSet = this.sample(formes);
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets[newSet]);
			}
		},
		secondary: null,
		target: "normal",
	...
	randomscreaming: {
		...
		secondary: {
			...
			status: 'frz',
			onHit() {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Gimmick')}|Show me some more paaain, baaaby`);
			},
		},
		thawsTarget: true,
		target: "normal",
	...
	gacha: {
		...
		onHit(target, source, move) {
			...
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'GMars')}|${message}`);
	...
	skyscrapersuplex: {
		...
		onBasePower(basePower, pokemon, target) {
			if (_optionalChain([target, 'optionalAccess', _9 => _9.statsRaisedThisTurn])) {
				return this.chainModify(2);
			}
		},
		category: "Special",
	...
	thehuntison: {
		...
		onModifyMove(move, source, target) {
			if (_optionalChain([target, 'optionalAccess', _10 => _10.beingCalledBack])) move.accuracy = true;
		},
		...
		onAfterMoveSecondarySelf(pokemon, target, move) {
			if (!target || target.fainted || target.hp <= 0) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Jett')}|Owned!`);
			}
		},
		condition: {
			duration: 1,
		...
		onHit(pokemon) {
			if (pokemon.species.baseSpecies === 'Toxtricity') {
				if (pokemon.species.forme === 'Low-Key') {
					_abilities.changeSet.call(void 0, this, pokemon, _randomteams.ssbSets['Jho']);
				} else {
					_abilities.changeSet.call(void 0, this, pokemon, _randomteams.ssbSets['Jho-Low-Key']);
				}
			}
		},
		boosts: {
	...
	cozycuddle: {
		...
		condition: {
			...
			onTrapPokemon(pokemon) {
				if (_optionalChain([this, 'access', _11 => _11.effectState, 'access', _12 => _12.source, 'optionalAccess', _13 => _13.isActive])) pokemon.tryTrap();
			},
		},
		secondary: null,
		target: "normal",
	...
	kipup: {
		...
		condition: {
			...
			onDamage(damage, target, source, effect) {
				...
				if (_optionalChain([effect, 'optionalAccess', _14 => _14.effectType]) === 'Move' && damage >= target.hp) {
	...
	spamguess: {
		...
		onHit(target, source) {
			for (const move of ['Haze', 'Worry Seed', 'Poison Powder', 'Stun Spore', 'Leech Seed']) {
				...
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Meicoo')}|That is not the answer - try again!`);
			}
	...
	notsoworthypirouette: {
		...
		onHit(target, source) {
			...
			const chance = _optionalChain([source, 'access', _15 => _15.volatiles, 'access', _16 => _16['notsoworthypirouette'], 'optionalAccess', _17 => _17.counter]) ? source.volatiles['notsoworthypirouette'].counter : 2;
	...
	technotubertransmission: {
		...
		onHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Notater517')}|/html For more phantasmic music, check out <a href = "http://spo.ink/tunes">this link.</a>`);
		},
		self: {
	...
	omzoom: {
		...
		onHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'OM~!')}|Bang Bang`);
		},
		flags: {protect: 1, mirror: 1},
		selfSwitch: true,
		secondary: null,
	...
	balefulblaze: {
		...
		onAfterMoveSecondarySelf(pokemon, target, move) {
			if (!target || target.fainted || target.hp <= 0) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'PartMan')}|FOR SNOM!`);
	...
	trickery: {
		...
		onHit(target, source, effect) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Perish Song')}|/html <img src="https://i.imgflip.com/3rt1d8.png" width="262" height="150" />`);
			const item = target.takeItem(source);
			if (!target.item) {
	...
	dungeonsdragons: {
		...
		onHit(target, source, move) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'PiraTe Princess')}|did someone say d&d?`);
	...
	swampyterrain: {
		...
		condition: {
			duration: 5,
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _18 => _18.hasItem, 'call', _19 => _19('terrainextender')])) {
					return 8;
				}
				return 5;
			},
			...
			onFieldStart(field, source, effect) {
				if (_optionalChain([effect, 'optionalAccess', _20 => _20.effectType]) === 'Ability') {
	...
	inversionterrain: {
		...
		condition: {
			duration: 5,
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _21 => _21.hasItem, 'call', _22 => _22('terrainextender')])) {
					return 8;
				}
				return 5;
			},
			...
			onFieldStart(field, source, effect) {
				if (_optionalChain([effect, 'optionalAccess', _23 => _23.effectType]) === 'Ability') {
	...
	stonykibbles: {
		...
		onHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Raihan Kibana')}|Let the winds blow! Stream forward, Sandstorm!`);
		},
		onPrepareHit(target, source) {
			this.add('-anim', source, 'Rock Slide', target);
	...
	pitchblackterrain: {
		...
		condition: {
			duration: 5,
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _24 => _24.hasItem, 'call', _25 => _25('terrainextender')])) {
					return 8;
				}
				return 5;
			},
			onHit(target, source, move) {
				...
				if (_optionalChain([move, 'optionalAccess', _26 => _26.effectType]) === 'Move' && move.category !== 'Status') {
			...
			onSwitchInPriority: -1,
			onSwitchIn(target) {
				if (_optionalChain([target, 'optionalAccess', _27 => _27.species, 'access', _28 => _28.name]) !== 'Mismagius') return;
			...
			onFieldStart(field, source, effect) {
				...
				if (_optionalChain([source, 'optionalAccess', _30 => _30.species, 'access', _31 => _31.name]) !== 'Mismagius') return;
	...
	homunculussvanity: {
		...
		self: {
			onHit(source) {
				...
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Sectonia')}|Jelly baby ;w;`);
			},
		},
		secondary: null,
		target: "self",
	...
	tsukuyomi: {
		...
		onHit(pokemon, source, move) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Segmr')}|I don't like naruto actually let someone else write this message plz.`);
	...
	badopinion: {
		...
		onHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'sejesensei')}|Please go read To Love-Ru I swear its really good, wait... don’t leave…`);
		},
		self: {
			boosts: {
				def: 1,
	...
	legendaryswordsman: {
		...
		onTry(source, target) {
			...
			const move = _optionalChain([action, 'optionalAccess', _32 => _32.choice]) === 'move' ? action.move : null;
			if (!move || (move.category === 'Status' && move.id !== 'mefirst') || target.volatiles['mustrecharge']) {
				if (_optionalChain([move, 'optionalAccess', _33 => _33.category]) === 'Status') {
					this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Seso')}|Irritating a better swordsman than yourself is always a good way to end up dead.`);
				} else {
					this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Seso')}|Scars on the back are a swordsman's shame.`);
				}
				return false;
			}
		},
		...
		onPrepareHit(target, source) {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Seso')}|FORWARD!`);
	...
	veto: {
		...
		onHit(target, source) {
			if (source.m.statsRaisedLastTurn) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Struchni')}|**veto**`);
			}
		},
		target: "normal",
		type: "Steel",
	...
	rightoncue: {
		...
		onHit(target, source) {
			...
			if (successes === 1) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'tiki')}|truly a dumpster fire`);
			} else if (successes >= 4) {
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'tiki')}|whos ${source.side.foe.name}?`);
			}
		},
		secondary: null,
		target: "self",
	...
	glitchexploiting: {
		...
		onHit(target, source, move) {
			...
			if (random === 1) {
				...
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Volco')}|haha memory corruption go brrr...`);
		...
		secondaries: [
			{
				...
				onHit(target, source) {
					...
					this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Volco')}|Ever just screw up the trick and corrupt the memory and cause the wrong thing to happen possibly ruining a run? No? Just me? okay...`);
					if (this.randomChance(1, 2)) {
	...
	classchange: {
		...
		onPrepareHit(foe, source, move) {
			const formes = ['Cleric', 'Ninja', 'Dancer', 'Songstress', 'Jester']
				.filter(forme => _randomteams.ssbSets[`yuki-${forme}`].species !== source.species.name);
		...
		onHit(target, source) {
			...
			switch (source.m.yukiCosplayForme) {
			case 'Cleric':
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['yuki-Cleric']);
				this.add('-message', 'yuki patches up her wounds!');
				return;
			case 'Ninja':
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['yuki-Ninja']);
				this.add('-message', `yuki's fast movements confuse ${target.name}!`);
				return;
			case 'Dancer':
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['yuki-Dancer']);
				this.add('-message', `yuki dazzles ${target.name} with her moves!`);
				return;
			case 'Songstress':
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['yuki-Songstress']);
				this.add('-message', `yuki sang an entrancing melody!`);
				return;
			case 'Jester':
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['yuki-Jester']);
	...
	ingredientforaging: {
		...
		onAfterHit(target, source) {
			...
			if (source.hp && target.takeItem(source)) {
				...
				this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Zalm')}|Yum`);
	...
	relicdance: {
		...
		onAfterMove(source) {
			...
			if (source.species.name === "Meloetta-Pirouette") {
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['Zarel']);
			} else {
				_abilities.changeSet.call(void 0, this, source, _randomteams.ssbSets['Zarel-Pirouette']);
			}
		},
		onModifyMove(move, pokemon) {
	...
	bigstormcoming: {
		...
		onPrepareHit() {
			this.add(`c:|${Math.floor(Date.now() / 1000)}|${_conditions.getName.call(void 0, 'Zodiax')}|There is a hail no storm okayyyyyy`);
		},
		onTry(pokemon, target) {
