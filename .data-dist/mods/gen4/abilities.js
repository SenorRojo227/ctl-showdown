"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } const Abilities = {
	...
	intimidate: {
		...
		onStart(pokemon) {
			const activated = pokemon.adjacentFoes().some(target => (
				!(target.volatiles['substitute'] || _optionalChain([target, 'access', _ => _.volatiles, 'access', _2 => _2['substitutebroken'], 'optionalAccess', _3 => _3.move]) === 'uturn')
			));
			...
			for (const target of pokemon.adjacentFoes()) {
				...
				} else if (_optionalChain([target, 'access', _4 => _4.volatiles, 'access', _5 => _5['substitutebroken'], 'optionalAccess', _6 => _6.move]) === 'uturn') {
	...
	liquidooze: {
		...
		onSourceTryHeal(damage, target, source, effect) {
			...
			if (canOoze.includes(effect.id) && _optionalChain([this, 'access', _7 => _7.activeMove, 'optionalAccess', _8 => _8.id]) !== 'dreameater') {
	...
	tangledfeet: {
		...
		onModifyAccuracy(accuracy, target) {
			if (typeof accuracy !== 'number') return;
			if (_optionalChain([target, 'optionalAccess', _9 => _9.volatiles, 'access', _10 => _10['confusion']])) {
