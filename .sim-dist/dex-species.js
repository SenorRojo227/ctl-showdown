"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }var _dexdata = require('./dex-data');
	...
	getByID(id) {
		...
		if (id && this.dex.data.Pokedex.hasOwnProperty(id)) {
			...
			species.nfe = species.evos.some(evo => {
				...
				return !evoSpecies.isNonstandard || evoSpecies.isNonstandard === _optionalChain([species, 'optionalAccess', _ => _.isNonstandard]);
			});
