 ...
 *********************************************************/
 ...
 = {
	...
	reportCrash(err, crasher = "The server") {
		...
		const stack = typeof err === 'string' ? err : _optionalChain([err, 'optionalAccess', _34 => _34.stack]) || _optionalChain([err, 'optionalAccess', _35 => _35.message]) || _optionalChain([err, 'optionalAccess', _36 => _36.name]) || '';
		...
		if (devRoom) {
			...
			_optionalChain([exports.Rooms, 'access', _37 => _37.lobby, 'optionalAccess', _38 => _38.add, 'call', _39 => _39(crashMessage), 'access', _40 => _40.update, 'call', _41 => _41()]);
			_optionalChain([exports.Rooms, 'access', _42 => _42.get, 'call', _43 => _43('staff'), 'optionalAccess', _44 => _44.add, 'call', _45 => _45(crashMessage), 'access', _46 => _46.update, 'call', _47 => _47()]);
		}
 ...
 class GameRoom extends BasicRoom {
	...
	constructor(roomid, title, options) {
		...
		this.p1 = _optionalChain([options, 'access', _48 => _48.p1, 'optionalAccess', _49 => _49.user]) || null;
		this.p2 = _optionalChain([options, 'access', _50 => _50.p2, 'optionalAccess', _51 => _51.user]) || null;
		this.p3 = _optionalChain([options, 'access', _52 => _52.p3, 'optionalAccess', _53 => _53.user]) || null;
		this.p4 = _optionalChain([options, 'access', _54 => _54.p4, 'optionalAccess', _55 => _55.user]) || null;
	...
	async uploadReplay(user, connection, options) {
		...
		const [success] = await LoginServer.request('prepreplay', {
			...
			inputlog: _optionalChain([battle, 'access', _56 => _56.inputLog, 'optionalAccess', _57 => _57.join, 'call', _58 => _58('\n')]) || null,
		});
		if (_optionalChain([success, 'optionalAccess', _59 => _59.errorip])) {
...
function getRoom(roomid) {
 ...
 const Rooms = {
	...
	SimpleRoomGame: _roomgame.SimpleRoomGame,
