...
// User
 class User extends Chat.MessageContext {
	...
	updateGroup(registered, isMerge) {
		...
		_optionalChain([exports.Users, 'access', _3 => _3.Avatars, 'optionalAccess', _4 => _4.handleLogin, 'call', _5 => _5(this)]);

		const groupInfo = Config.groups[this.tempGroup];
		this.isStaff = !!(groupInfo && (groupInfo.lock || groupInfo.root));
		if (!this.isStaff) {
			const rank = _optionalChain([Rooms, 'access', _6 => _6.get, 'call', _7 => _7('staff'), 'optionalAccess', _8 => _8.auth, 'access', _9 => _9.getDirect, 'call', _10 => _10(this.id)]);
	...
	setGroup(group, forceTrusted = false) {
		...
		this.isStaff = !!(groupInfo && (groupInfo.lock || groupInfo.root));
		if (!this.isStaff) {
			const rank = _optionalChain([Rooms, 'access', _11 => _11.get, 'call', _12 => _12('staff'), 'optionalAccess', _13 => _13.auth, 'access', _14 => _14.getDirect, 'call', _15 => _15(this.id)]);
			this.isStaff = !!(rank && rank !== '*' && rank !== exports.Users.Auth.defaultSymbol());
		}
		Rooms.global.checkAutojoin(this);
		if (this.registered) {
	...
	async tryJoinRoom(roomid, connection) {
		...
		if (!_optionalChain([room, 'optionalAccess', _16 => _16.checkModjoin, 'call', _17 => _17(this)])) {
			if (!this.named) {
