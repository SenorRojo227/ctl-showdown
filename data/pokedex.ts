export const Pokedex: {[speciesid: string]: SpeciesData} = {
	moofy: {
		...
		abilities: {0: "Expressive", H: "Authoritative Figure"},
		heightm: 6.1,
		weightkg: 42,
		color: "Brown",
		eggGroups: ["Monster"],
	...
	martijn: {
		...
		types: ["Heart", "Toxic"],
		gender: "M",
		baseStats: {hp: 70, atk: 70, def: 70, spa: 70, spd: 70, spe: 120},
		abilities: {0: "Huge Power", H: "Swift Swim"},
		heightm: 6,
		weightkg: 42,
		color: "White",
		eggGroups: ["Monster"],
	...
	slowbro: {
		...
		name: "Slowbro",
		types: ["Water", "Psychic"],
		baseStats: {hp: 100, atk: 75, def: 110, spa: 100, spd: 80, spe: 30},
		abilities: {0: "Unaware", 1: "Own Tempo", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 78.5,
		color: "Pink",
		prevo: "Slowpoke",
